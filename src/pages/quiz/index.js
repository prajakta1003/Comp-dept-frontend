...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const getQuestions = async () => {
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URI}/api/quizzes/survey`, {
        method: "GET",
      });
  ...
  const handleResult = async () => {
    ...
    const response = await fetch(`${process.env.REACT_APP_BACKEND_URI}/api/score/survey`, {
      method: "POST",
      headers: {
